...
| Live prototype / app | **Local / team demo:** run from repo (`npm run dev:all` → http://localhost:5173). **Public deploy:** **[TODO — paste Vercel / production URL if any]** |
| Figma & design files | **[TODO — paste Figma link; set OHHF to Editor/Owner]** |
| Code repository | https://github.com/SpurtiNimbali/OHHF_CS52 |
